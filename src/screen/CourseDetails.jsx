  ...
  return (
          ...
          <SafeAreaView>
            <ScrollView>
              ...
              <View style={styles.container}>
                <Text style={styles.courseName}>Course Schedule</Text>
              </View>
                ...
                <View style={styles.feedItem}>
                  ...
                  <View style={{ flex: 1 }}>
                    <View style={styles.row}>
                      <View>
                        <Text style={styles.name}>Instructor: {course?.Teacher.Username}</Text>
                        <Text style={styles.postDesc}>Course Time: {course?.LectureDate ? course?.LectureDate : "-"}</Text>
                      </View>
                    </View>
                    <View style={styles.row}>
                    </View>
